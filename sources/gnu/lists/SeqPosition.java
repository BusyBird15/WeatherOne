...
public class SeqPosition implements ListIterator, Enumeration {
    ...
    public static SeqPosition make(AbstractSequence seq, int ipos2) {
        return new SeqPosition(seq, seq.copyPos(ipos2));
    }
    ...
    public void setPos(AbstractSequence seq, int ipos2) {
