...
public class GetNamedPart extends Procedure2 implements HasSetter {
    ...
    public static Object getNamedPart(Object container, Symbol part) throws Throwable {
        ...
        if (container instanceof Package) {
            try {
                return ClassType.getContextClass(((Package) container).getName() + '.' + name);
            } catch (Throwable th) {
            }
        }
    ...
    public static Object getMemberPart(Object container, String name) throws Throwable {
        try {
            ...
            MethodProc methods = ClassMethods.apply((ClassType) ClassType.make(container.getClass()), Compilation.mangleName(name), 0, Language.getDefaultLanguage());
            if (methods != null) {
