...
class SetArrayExp extends ApplyExp {
    ...
    public SetArrayExp(Expression array, ArrayType arrayType) {
        super((Procedure) Invoke.make, new QuoteExp(typeSetArray), array);
    ...
    public Expression validateApply(ApplyExp exp, InlineCalls visitor, Type required, Declaration decl) {
        ...
        return visitor.visitApplyOnly(new ApplyExp((Procedure) new ArraySet(this.elementType), getArgs()[1], args[0], args[1]), required);
    }
}
