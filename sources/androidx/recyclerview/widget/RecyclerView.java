...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    private void createLayoutManager(android.content.Context r11, java.lang.String r12, android.util.AttributeSet r13, int r14, int r15) {
        ...
        L_0x001e:
            ...
            java.lang.Class<androidx.recyclerview.widget.RecyclerView$LayoutManager> r8 = androidx.recyclerview.widget.RecyclerView.LayoutManager.class
        ...
        L_0x0047:
            ...
            androidx.recyclerview.widget.RecyclerView$LayoutManager r7 = (androidx.recyclerview.widget.RecyclerView.LayoutManager) r7     // Catch:{ ClassNotFoundException -> 0x0088, InvocationTargetException -> 0x00aa, InstantiationException -> 0x00cc, IllegalAccessException -> 0x00ee, ClassCastException -> 0x0110 }
    ...
    private boolean findInterceptingOnItemTouchListener(MotionEvent e) {
        ...
        while (i < listenerCount) {
            ...
            if (!listener.onInterceptTouchEvent(this, e) || action == 1 || action == 3) {
                i++;
            } else {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r22) {
        ...
        L_0x000d:
            return r1
        L_0x000e:
            boolean r1 = r21.dispatchToOnItemTouchListeners(r22)
    ...
    public final void fillRemainingScrollValues(State state) {
        if (Build.VERSION.SDK_INT < 9 || getScrollState() != 2) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (Build.VERSION.SDK_INT < 9) {
                stop();
            } else if (RecyclerView.this.mLayout == null) {
                stop();
            } else {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (Build.VERSION.SDK_INT < 9 || RecyclerView.this.getOverScrollMode() != 2) {
    ...
    static void clearNestedRecyclerViewIfNotNested(@androidx.annotation.NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder r3) {
        /*
            java.lang.ref.WeakReference<androidx.recyclerview.widget.RecyclerView> r2 = r3.mNestedRecyclerView
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = Declaration.MODULE_REFERENCE;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        public void getTransformedBoundingBox(@NonNull View child, boolean includeDecorInsets, @NonNull Rect out) {
            ...
            if (Build.VERSION.SDK_INT >= 11 && this.mRecyclerView != null && (childMatrix = child.getMatrix()) != null && !childMatrix.isIdentity()) {
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), Declaration.MODULE_REFERENCE), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), Declaration.MODULE_REFERENCE));
        }
