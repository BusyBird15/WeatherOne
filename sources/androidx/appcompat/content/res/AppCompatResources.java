...
public final class AppCompatResources {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(@androidx.annotation.NonNull android.content.Context r5, @androidx.annotation.ColorRes int r6) {
        /*
            ...
            monitor-enter(r3)
            java.util.WeakHashMap<android.content.Context, android.util.SparseArray<androidx.appcompat.content.res.AppCompatResources$ColorStateListCacheEntry>> r2 = sColorStateCaches     // Catch:{ all -> 0x0035 }
            ...
            androidx.appcompat.content.res.AppCompatResources$ColorStateListCacheEntry r1 = (androidx.appcompat.content.res.AppCompatResources.ColorStateListCacheEntry) r1     // Catch:{ all -> 0x0035 }
