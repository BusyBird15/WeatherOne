...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0018 A[Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }] */
    ...
    public static androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat create(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.DrawableRes int r8, @androidx.annotation.Nullable android.content.res.Resources.Theme r9) {
        /*
            r6 = 2
            android.content.res.Resources r3 = r7.getResources()     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            android.content.res.XmlResourceParser r2 = r3.getXml(r8)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r2)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
        L_0x000d:
            int r4 = r2.next()     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            if (r4 == r6) goto L_0x0016
            r5 = 1
            if (r4 != r5) goto L_0x000d
        L_0x0016:
            if (r4 == r6) goto L_0x002a
            org.xmlpull.v1.XmlPullParserException r5 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            java.lang.String r6 = "No start tag found"
            r5.<init>(r6)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            throw r5     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
        L_0x0020:
            r1 = move-exception
        ...
        L_0x0029:
            return r5
        L_0x002a:
            androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat r5 = createFromXmlInner(r7, r3, r2, r0, r9)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            goto L_0x0029
        L_0x002f:
            r1 = move-exception
            java.lang.String r5 = LOGTAG
