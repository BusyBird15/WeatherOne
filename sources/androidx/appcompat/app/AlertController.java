...
class AlertController {
    ...
    public static class AlertParams {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: androidx.appcompat.app.AlertController$CheckedItemAdapter} */
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v5, resolved type: androidx.appcompat.app.AlertController$AlertParams$1} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v6, resolved type: androidx.appcompat.app.AlertController$AlertParams$2} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v7, resolved type: androidx.appcompat.app.AlertController$AlertParams$2} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v8, resolved type: androidx.appcompat.app.AlertController$AlertParams$2} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v22, resolved type: androidx.appcompat.app.AlertController$AlertParams$2} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v9, resolved type: androidx.appcompat.app.AlertController$AlertParams$2} */
        ...
        private void createListView(final androidx.appcompat.app.AlertController r11) {
            /*
                ...
                androidx.appcompat.app.AlertController$AlertParams$1 r0 = new androidx.appcompat.app.AlertController$AlertParams$1
