...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r18) {
        /*
            r17 = this;
            r0 = r17
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r15 = r0.mReceivers
            monitor-enter(r15)
        ...
        L_0x0062:
            r0 = r17
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r1 = r0.mActions     // Catch:{ all -> 0x010b }
        ...
        L_0x0090:
            ...
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r13 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r13     // Catch:{ all -> 0x010b }
        ...
        L_0x013f:
            ...
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r1 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r1     // Catch:{ all -> 0x010b }
            r7 = 0
        ...
        L_0x0151:
            r0 = r17
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r1 = r0.mPendingBroadcasts     // Catch:{ all -> 0x010b }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r7 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x010b }
            r0 = r18
    ...
    public void executePendingBroadcasts() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r8 = r10.mReceivers
            monitor-enter(r8)
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r7 = r10.mPendingBroadcasts     // Catch:{ all -> 0x0041 }
            int r0 = r7.size()     // Catch:{ all -> 0x0041 }
            if (r0 > 0) goto L_0x000d
            monitor-exit(r8)     // Catch:{ all -> 0x0041 }
            return
        L_0x000d:
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord[] r2 = new androidx.localbroadcastmanager.content.LocalBroadcastManager.BroadcastRecord[r0]     // Catch:{ all -> 0x0041 }
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r7 = r10.mPendingBroadcasts     // Catch:{ all -> 0x0041 }
        ...
        L_0x001b:
            ...
            r1 = r2[r3]
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord> r7 = r1.receivers
            int r5 = r7.size()
            r4 = 0
        L_0x0027:
            if (r4 >= r5) goto L_0x0044
