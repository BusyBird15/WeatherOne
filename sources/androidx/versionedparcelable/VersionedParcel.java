...
public abstract class VersionedParcel {
    ...
    private <T, S extends java.util.Collection<T>> S readCollection(int r4, S r5) {
        ...
        L_0x0017:
            if (r0 <= 0) goto L_0x0008
            androidx.versionedparcelable.VersionedParcelable r2 = r3.readVersionedParcelable()
            r5.add(r2)
            int r0 = r0 + -1
            goto L_0x0017
        L_0x0023:
        ...
        L_0x002f:
            if (r0 <= 0) goto L_0x0008
            android.os.Parcelable r2 = r3.readParcelable()
            r5.add(r2)
            int r0 = r0 + -1
            goto L_0x002f
        L_0x003b:
            if (r0 <= 0) goto L_0x0008
            java.io.Serializable r2 = r3.readSerializable()
            r5.add(r2)
            int r0 = r0 + -1
            goto L_0x003b
        L_0x0047:
    ...
    public <T> T[] readArray(T[] r5) {
        ...
        L_0x0018:
            java.lang.Object[] r3 = r0.toArray(r5)
            goto L_0x0007
        L_0x001d:
            if (r1 <= 0) goto L_0x0018
        ...
        L_0x0029:
            if (r1 <= 0) goto L_0x0018
            android.os.Parcelable r3 = r4.readParcelable()
            r0.add(r3)
            int r1 = r1 + -1
            goto L_0x0029
        L_0x0035:
            if (r1 <= 0) goto L_0x0018
            androidx.versionedparcelable.VersionedParcelable r3 = r4.readVersionedParcelable()
            r0.add(r3)
            int r1 = r1 + -1
            goto L_0x0035
        L_0x0041:
            if (r1 <= 0) goto L_0x0018
            java.io.Serializable r3 = r4.readSerializable()
            r0.add(r3)
            int r1 = r1 + -1
            goto L_0x0041
        L_0x004d:
